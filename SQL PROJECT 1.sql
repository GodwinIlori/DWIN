...
SELECT v.Name AS VendorName, p.Name AS ProductName, COUNT(p.ProductID) AS NumberOfProducts
...
ORDER BY v.Name, NumberOfProducts DESC;
...
--7. Subquery with Aggregate and JOIN: Find products with a total sales value greater than $1,000,000
...
--8. Find people who have more than one email address.
